...
class __update_environment_spec(typing_extensions.Protocol):
    def __call__(self, current_name: str, *, new_name: typing.Union[str, None] = None, new_web_suffix: typing.Union[str, None] = None):
        ...
...
class __list_environments_spec(typing_extensions.Protocol):
    def __call__(self) -> typing.List[modal_proto.api_pb2.EnvironmentListItem]:
        ...
